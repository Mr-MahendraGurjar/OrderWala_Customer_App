import 'package:activeitzone/custom/box_decorations.dart';
import 'package:activeitzone/custom/btn.dart';
import 'package:activeitzone/custom/enum_classes.dart';
import 'package:activeitzone/custom/lang_text.dart';
import 'package:activeitzone/custom/toast_component.dart';
import 'package:activeitzone/helpers/shared_value_helper.dart';
import 'package:activeitzone/helpers/shimmer_helper.dart';
...
import 'package:activeitzone/repositories/coupon_repository.dart';
import 'package:activeitzone/repositories/payment_repository.dart';
import 'package:activeitzone/screens/orders/order_list.dart';
import 'package:activeitzone/screens/payment_method_screen/amarpay_screen.dart';
import 'package:activeitzone/screens/payment_method_screen/bkash_screen.dart';
import 'package:activeitzone/screens/payment_method_screen/flutterwave_screen.dart';
import 'package:activeitzone/screens/payment_method_screen/iyzico_screen.dart';
import 'package:activeitzone/screens/payment_method_screen/khalti_screen.dart';
import 'package:activeitzone/screens/payment_method_screen/my_fatoora_screen.dart';
import 'package:activeitzone/screens/payment_method_screen/nagad_screen.dart';
import 'package:activeitzone/screens/payment_method_screen/offline_screen.dart';
import 'package:activeitzone/screens/payment_method_screen/online_pay.dart';
import 'package:activeitzone/screens/payment_method_screen/payfast_screen.dart';
import 'package:activeitzone/screens/payment_method_screen/paypal_screen.dart';
import 'package:activeitzone/screens/payment_method_screen/paystack_screen.dart';
import 'package:activeitzone/screens/payment_method_screen/paytm_screen.dart';
import 'package:activeitzone/screens/payment_method_screen/phonepay_screen.dart';
import 'package:activeitzone/screens/payment_method_screen/razorpay_screen.dart';
import 'package:activeitzone/screens/payment_method_screen/sslcommerz_screen.dart';
import 'package:activeitzone/screens/payment_method_screen/stripe_screen.dart';
...
class _CheckoutState extends State<Checkout> {
  ...
  fetchAll() {
    ...
    if (widget.paymentFor != PaymentFor.Order) {
      ...
      if (widget.paymentFor == PaymentFor.OrderRePayment) {
        ...
        payment_type =
            widget.paymentFor == PaymentFor.WalletRecharge ? "wallet_payment" : "customer_package_payment";
      }
    } else {
      fetchSummary();
    }
  ...
  fetchList() async {
    String mode = '';
    setState(() {
      mode = widget.paymentFor != PaymentFor.Order && widget.paymentFor != PaymentFor.ManualPayment
          ? "wallet"
          : "order";
    });

    var paymentTypeResponseList =
        await PaymentRepository().getPaymentResponseList(list: widget.list, mode: mode);
  ...
  onCouponApply() async {
    ...
    var couponApplyResponse = await CouponRepository().getCouponApplyResponse(coupon_code);
  ...
  onCouponRemove() async {
    var couponRemoveResponse = await CouponRepository().getCouponRemoveResponse();
  ...
  onPressPlaceOrderOrProceed() async {
    debugPrint('enter $_selected_payment_method');
    if (guest_checkout_status.$ && !is_logged_in.$) {
      Loading.show(context);
      // guest checkout user create response

      var guestUserAccountCreateResponse =
          await GuestCheckoutRepository().guestUserAccountCreate(widget.guestCheckOutShippingAddress);
      Loading.close();
      ...
      if (!guestUserAccountCreateResponse.result!) {
        ...
        Navigator.pushAndRemoveUntil(OneContext().context!, MaterialPageRoute(builder: (context) {
...
//          offLinePaymentFor: widget.offLinePaymentFor,
  ...
  pay_by_cod() async {
    ...
    var orderCreateResponse =
        await PaymentRepository().getOrderCreateResponseFromCod(_selected_payment_method_key);
  ...
  pay_by_manual_payment() async {
    loading();
    var orderCreateResponse =
        await PaymentRepository().getOrderCreateResponseFromManualPayment(_selected_payment_method_key);
  ...
  onPaymentMethodItemTap(index) {
    if (_selected_payment_method_key != _paymentTypeList[index].payment_type_key) {
      setState(() {
                          ...
                          children: [
                            Container(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                    color: MyTheme.font_grey, fontSize: 14, fontWeight: FontWeight.w600),
                              ),
                            ),
                            Spacer(),
                            Text(
                              SystemConfig.systemCurrency != null
                                  ...
                                  : _subTotalString!,
                              style:
                                  TextStyle(color: MyTheme.font_grey, fontSize: 14, fontWeight: FontWeight.w600),
                            ),
                          ],
                        )),
                    Padding(
        ...
        body: Stack(
          children: [
            ...
            Align(
              ...
              child:
                  widget.paymentFor == PaymentFor.WalletRecharge || widget.paymentFor == PaymentFor.PackagePay
                      ? Container()
                      : Container(
                          decoration: BoxDecoration(
                            color: Colors.white,
                          ),
                          height: widget.paymentFor == PaymentFor.ManualPayment ? 80 : 140,
                          //color: Colors.white,
                          child: Padding(
                            padding: const EdgeInsets.all(16.0),
                            child: Column(
        ...
        children: [
          AnimatedContainer(
            ...
            decoration: BoxDecorations.buildBoxDecoration_1().copyWith(
                border: Border.all(
                    color: _selected_payment_method_key == _paymentTypeList[index].payment_type_key
                        ? MyTheme.accent_color
                        : MyTheme.light_grey,
                    width: _selected_payment_method_key == _paymentTypeList[index].payment_type_key
                        ? 2.0
                        : 0.0)),
              ...
              Container(
                  ...
                  child: Padding(
                      ...
                      child:
                        ...
                        image: _paymentTypeList[index].payment_type == "manual_payment"
                            ? _paymentTypeList[index].image
                            : _paymentTypeList[index].image,
                        fit: BoxFit.fitWidth,
                      ))),
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text(
                        ...
                        maxLines: 2,
                        style: TextStyle(
                            color: MyTheme.font_grey, fontSize: 14, height: 1.6, fontWeight: FontWeight.w400),
                      ),
                    ),
                  ],
                ),
  ...
  Widget grandTotalSection() {
    return Container(
      height: 40,
      width: double.infinity,
      decoration: BoxDecoration(borderRadius: BorderRadius.circular(8.0), color: MyTheme.soft_accent_color),
      child: Padding(
