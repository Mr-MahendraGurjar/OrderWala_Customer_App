...
class MyTheme {
  ...
  static const Color accent_color = Color(0xff102863);
  ...
  static Color splash_screen_color = Color(0xff102863); // if not sure , use the same color as accent color
  ...
  //---------------
  static const Color brick_red =Color(0xff102863);
  static const Color cinnabar = Color(0xff102863);
